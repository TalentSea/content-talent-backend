...
def generate_tus_signature(library_id: str, bunny_api_key: str, video_id: str, expires_in_seconds: Optional[int] = None) -> tuple[str, int]:
    """
...
def generate_signed_playback_url(bunny_pull_zone_url: str, bunny_video_id: str, token_security_key: str, expires_in_seconds: Optional[int] = None) -> str:
    """
...
def generate_signed_mp4_url(bunny_pull_zone_url: str, bunny_video_id: str, resolution: str, token_security_key: str, expires_in_seconds: Optional[int] = None) -> str:
    """
