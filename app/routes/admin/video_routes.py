...
def initiate_video(payload: VideoInitiateRequest, current_user: dict = Depends(get_current_admin)):
    """
...
def get_video_details(video_id: int, current_user: dict = Depends(get_current_admin)):
    """
...
def update_video_metadata(video_id: int, payload: VideoUpdateRequest, current_user: dict = Depends(get_current_admin)):
    """
...
def upload_thumbnail(video_id: int, slot: int = Query(0, ge=0, le=2), file: UploadFile = File(...), current_user: dict = Depends(get_current_admin)):
    """
...
def select_main_thumbnail(video_id: int, payload: SelectMainThumbnailRequest, current_user: dict = Depends(get_current_admin)):
    """
...
def delete_thumbnail(video_id: int, payload: DeleteThumbnailRequest, current_user: dict = Depends(get_current_admin)):
    """
...
def delete_video(video_id: int, current_user: dict = Depends(get_current_admin)):
    """
...
def bulk_delete_videos(payload: BulkDeleteVideosRequest, current_user: dict = Depends(get_current_admin)):
    """
...
def publish_video(video_id: int, current_user: dict = Depends(get_current_admin)):
    """
...
def schedule_video(video_id: int, payload: VideoScheduleRequest, current_user: dict = Depends(get_current_admin)):
    """
