...
def get_creator_profile(current_user: dict = Depends(get_current_user)):
    """
...
def update_creator_profile(payload: ProfileUpdateRequest, current_user: dict = Depends(get_current_user)):
    """
...
def upload_profile_photo(photo: UploadFile = File(...), current_user: dict = Depends(get_current_user)):
    """
