...
from app.routes.mobile.payment_routes import router as mobile_payment_router
...
from app.routes.mobile.subscription_routes import (
    router as mobile_subscription_router,
)
