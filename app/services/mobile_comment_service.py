...
class MobileCommentService:
    ...
    def list_video_comments(
        ...
        for c in comments:
            ...
            is_liked = self.comment_repo.is_comment_liked_by_subscriber(c.id, subscriber_id) if subscriber_id else False
    ...
    def create_video_comment(
        ...
        comment = self.comment_repo.create_top_level_comment(video, subscriber, payload.text.strip())
    ...
    def get_comment_replies(
        ...
        for r in replies_raw:
            is_liked = self.comment_repo.is_comment_liked_by_subscriber(r.id, subscriber_id) if subscriber_id else False
    ...
    def create_comment_reply(
        ...
        reply = self.comment_repo.create_subscriber_reply(parent_comment, subscriber, payload.text.strip())
    ...
    def toggle_comment_like(self, comment_id: int, subscriber_id: int) -> MobileCommentLikeResponse:
        """
    ...
    def delete_comment(self, comment_id: int, subscriber_id: int) -> ActionSuccessResponse:
        """
